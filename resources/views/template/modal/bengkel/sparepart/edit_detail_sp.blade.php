<div class="modal fade" id="edit-detail-sp-modal" tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="edit-detail-sp-modal-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <ul class="alert alert-danger hidden" id="error-edit-detail-sp">

                        </ul>
                    </div>

                    <form id="edit-detail-sp-form" method="post">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 quetion-wrapper" style="font-size: 16px;">
                                <input type="hidden" name="detail_sp_id" value="">
