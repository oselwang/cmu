<div class="modal fade" id="create-tipe-sp-modal" tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="create-tipe-sp-modal-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <ul class="alert alert-danger hidden" id="error-create-tipe-sp">

                        </ul>
                    </div>

                    <form id="create-tipe-sp-form" method="post">
                        {{csrf_field()}}
                        <div class="row">
