<div class="modal fade" id="create-user-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" id="create-user-modal-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <ul class="alert alert-danger hidden" id="error-create-user">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 quetion-wrapper" style="font-size: 16px;">
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <input type="checkbox" value="2" name="dealer_id[]"> CMURGT - CV. Cipta Mitra Usaha-Rengat<br>
